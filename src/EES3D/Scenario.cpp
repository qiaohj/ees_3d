...
Scenario::Scenario(string p_env_db, string p_conf_db, string p_target, bool p_overwrite, int p_id, unsigned long p_mem_limit) {
    ...
    vector<Simulation*> simulations = initSimulations(conf_db, env_db, p_id, p_target, p_overwrite, neighborInfo);
...
vector<Simulation*> Scenario::initSimulations(sqlite3 *conf_db, sqlite3 *env_db, int p_id, string p_target, bool p_overwrite, Neighbor* neighborInfo) {
