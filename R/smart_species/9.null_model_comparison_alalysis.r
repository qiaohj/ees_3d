...
fix_df<-function(p_df){
  ...
  p_df<-p_df %>% filter((EVO_TYPE==1)||(EVO_RATIO==0.01)||(EVO_RATIO==0.005))
  p_df$EVO_RATIO<-1
  p_df$EVO_TYPE<-fix_type(p_df$EVO_TYPE)
  p_df$label<-paste(p_df$NB, p_df$DA, p_df$EVO_TYPE)
  p_df
}
...
saveRDS(sort_N_CELL, "../../../ees_3d_data/SMART_SPECIES/Tables/9.null_model_comparison_analysis/sort_N_CELL_Fixed.rda")
#sort_N_CELL<-readRDS("../../../ees_3d_data/SMART_SPECIES/Tables/9.null_model_comparison_analysis/sort_N_CELL_Fixed.rda")
...
saveRDS(mean_sort_N_CELL, "../../../ees_3d_data/SMART_SPECIES/Tables/9.null_model_comparison_analysis/mean_sort_N_CELL_Fixed.rda")
...
saveRDS(sort_AVERAGE_N_CELL, "../../../ees_3d_data/SMART_SPECIES/Tables/9.null_model_comparison_analysis/sort_AVERAGE_N_CELL_Fixed.rda")
sort_AVERAGE_N_CELL<-readRDS("../../../ees_3d_data/SMART_SPECIES/Tables/9.null_model_comparison_analysis/sort_AVERAGE_N_CELL_Fixed.rda")
...
saveRDS(mean_sort_AVERAGE_N_CELL, "../../../ees_3d_data/SMART_SPECIES/Tables/9.null_model_comparison_analysis/mean_sort_AVERAGE_N_CELL_Fixed.rda")
...
saveRDS(sort_N_SP, "../../../ees_3d_data/SMART_SPECIES/Tables/9.null_model_comparison_analysis/sort_N_SP_Fixed.rda")
sort_N_SP<-readRDS("../../../ees_3d_data/SMART_SPECIES/Tables/9.null_model_comparison_analysis/sort_N_SP_Fixed.rda")
...
saveRDS(mean_sort_N_SP, "../../../ees_3d_data/SMART_SPECIES/Tables/9.null_model_comparison_analysis/mean_sort_N_SP_Fixed.rda")
